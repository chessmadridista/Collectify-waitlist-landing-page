                        ...
                        <ul className="text-left font-medium flex flex-col items-center sm:items-start">
                            <div className="space-y-2 tracking-wide text-xl">
                                ...
                                <li className="flex gap-1.5 items-center text-left">
                                    ...
                                    Scattered Links in Notes Apps: Notes apps lack structure, making it hard to find links when you need them.
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <X className="h-4 w-4 shrink-0 text-red-500" />
                                    Bookmarks Mess: Browser bookmarks become cluttered and unmanageable over time.
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <X className="h-4 w-4 shrink-0 text-red-500" />
                                    Manual Sharing Is Tedious: Copying and pasting multiple links one by one is time-consuming and prone to mistakes.
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <X className="h-4 w-4 shrink-0 text-red-500" />
                                    No Shareable Organization: Other tools don’t let you create a single, elegant link for sharing collections.
                                </li>
                            </div>
                        </ul>
                    </div>
                        ...
                        <ul className="text-left font-medium flex flex-col items-center sm:items-start">
                            <div className="space-y-2 tracking-wide text-xl">
                                ...
                                <li className="flex gap-1.5 items-center text-left">
                                    ...
                                    All-in-One Simplicity: Add, organize, and share links seamlessly in just a few clicks.
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <Check className="h-4 w-4 shrink-0 text-green-600" />
                                    Clean and Professional Sharing: Share collections with a single, visually appealing link that looks professional and organized.                                
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <Check className="h-4 w-4 shrink-0 text-green-600" />
                                    Access Anywhere, Anytime: Enjoy cross-device accessibility for your collections.
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <Check className="h-4 w-4 shrink-0 text-green-600" />
                                    Intuitive and Beautiful Design: Our distraction-free interface ensures you focus on organizing, not figuring out how the tool works.                                
                                </li>
                                <li className="flex gap-1.5 items-center text-left">
                                    <Check className="h-4 w-4 shrink-0 text-green-600" />
                                    Tailored for Sharing: Specifically designed for creating and sharing collections in a way others will appreciate.
                                </li>
                            </div>
                        </ul>
                    </div>
